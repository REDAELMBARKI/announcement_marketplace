    ...
    <div>
      <div className="faq">
        ...
        <div className="cont">
          ...
          <p>
            {APP_NAME} is a platform where users can buy, sell, or donate items.
        ...
        <div className="cont">
          <h4>What makes {APP_NAME} Different? </h4>

          <ul>
            <li>
              •Focus on sustainability: unlike standard charities , {APP_NAME}
